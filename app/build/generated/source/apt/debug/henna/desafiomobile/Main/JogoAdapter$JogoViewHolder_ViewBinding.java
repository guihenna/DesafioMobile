...
public class JogoAdapter$JogoViewHolder_ViewBinding implements Unbinder {
  private JogoAdapter.JogoViewHolder target;

  private View view2131230808;

  @UiThread
  public JogoAdapter$JogoViewHolder_ViewBinding(final JogoAdapter.JogoViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    JogoAdapter.JogoViewHolder target = this.target;
