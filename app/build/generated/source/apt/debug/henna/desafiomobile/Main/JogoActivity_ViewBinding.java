...
public class JogoActivity_ViewBinding implements Unbinder {
  private JogoActivity target;

  @UiThread
  public JogoActivity_ViewBinding(JogoActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public JogoActivity_ViewBinding(JogoActivity target, View source) {
    this.target = target;
